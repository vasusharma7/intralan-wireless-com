...
public class RNNodeJsMobileModule extends ReactContextBaseJavaModule implements LifecycleEventListener {
  ...
  public void startNodeProject(final String mainFileName, ReadableMap options) throws Exception {
    ...
    if(!_startedNodeAlready) {
      ...
      Intent intent = new Intent(reactContext,NodeService.class);
      intent.putExtra("nodeJsProjectPath",nodeJsProjectPath);
      intent.putExtra("mainFileName",mainFileName);
      intent.putExtra("builtinModulesPath",builtinModulesPath);
